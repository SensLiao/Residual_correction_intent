...
# Every call is locked to its own held-out fold by the staged plan. When the
# frozen training receipts bind complete actual-validation probabilities, use
# their CPU/I/O handoff instead of predicting the same cases twice.

...
marker = Path("/mnt/HDD4/workspace/honor_degree/projects/petct_textual_intent/nnunet/envs/ENV_READY.done")
...
root = Path("/mnt/HDD4/workspace/honor_degree/projects/petct_textual_intent/nnunet/envs").resolve()
setup_mode = os.environ["PETCT_ENV_SETUP_MODE"]

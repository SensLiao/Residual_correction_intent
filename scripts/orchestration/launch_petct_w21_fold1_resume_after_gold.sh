...
export TMPDIR=/mnt/HDD4/zlei0805/.tmp
export LIBRARY_PATH=/mnt/HDD4/zlei0805/.local/lib:${LIBRARY_PATH:-}
export TORCHINDUCTOR_CACHE_DIR=/mnt/HDD4/zlei0805/.tmp/inductor_w21_5fold
